...
export function HomePage() {
	return (
		<>
		<Container>
			Really cool description of services, few links to most popular tracks, getting started button etc
		</Container>
		<MapTest/>
		</>
	);
...
function MapTest() {
	...
	let pts = gpx.tracks[0].points.map((p) => [p.lat, p.lon]);
	console.log(pts);
				...
				<Col>
					<div id="map">
						...
						>
							...
							<AntPath positions={pts} options={{color: "red"}} /> 
						</MapContainer>
					</div>
				</Col>
			</Row>
